...
public class KeychainQueryInjectionPolicyTest {
    ...
    private KeychainQueryInjectionPolicy keychainQueryInjectionPolicy;

    @Mock
    private KeychainQueryInjectionPolicyConfiguration keychainQueryInjectionPolicyConfiguration;
